...
void __declspec ( naked ) BattleGloveProp5() {
    ...
    _asm {
		...
		NextBattleGlove4:
        // ----
        CMP DWORD PTR SS: [EBP + 0x8], ITEM2 ( 0, 44 )
		...
		NextBattleGlove5:
        // ----
        CMP DWORD PTR SS: [EBP + 0x8], ITEM2 ( 0, 45 )
		...
		NextBattleGlove7:
        // ----
        CMP DWORD PTR SS: [EBP + 0x8], ITEM2 ( 0, 47 )
		...
		NextBattleGlove8:
        // ----
        CMP DWORD PTR SS: [EBP + 0x8], ITEM2 ( 0, 48 )
		...
		NextBattleGlove9:
        // ----
        CMP DWORD PTR SS: [EBP + 0x8], ITEM2 ( 0, 49 )
...
void __declspec ( naked ) oBattleGloveGlow() {
	...
	//--Gloves4
    else if ( dwBattleGlovesGlow_Pointer == ITEM2 ( 0, 44 ) ) {
        bBattleGlovesGlow_Switcher = FALSE;
        _asm {
            MOV DWORD PTR SS:[EBP-0x4], 0x2C
            JMP dwBattleGlovesGlow_Jump
	...
	//---Gloves5
    else if ( dwBattleGlovesGlow_Pointer == ITEM2 ( 0, 45 ) ) {
        bBattleGlovesGlow_Switcher = FALSE;
        _asm {
            MOV DWORD PTR SS:[EBP-0x4], 0x2C
            JMP dwBattleGlovesGlow_Jump
	...
	//---Gloves7
    else if ( dwBattleGlovesGlow_Pointer == ITEM2 ( 0, 47 ) ) {
        bBattleGlovesGlow_Switcher = FALSE;
        _asm {
            MOV DWORD PTR SS:[EBP-0x4], 0x2C
            JMP dwBattleGlovesGlow_Jump
	...
	//---Gloves8
    else if ( dwBattleGlovesGlow_Pointer == ITEM2 ( 0, 48 ) ) {
        bBattleGlovesGlow_Switcher = FALSE;
        _asm {
            MOV DWORD PTR SS:[EBP-0x4], 0x2C
            JMP dwBattleGlovesGlow_Jump
	...
	//---Gloves9
    else if ( dwBattleGlovesGlow_Pointer == ITEM2 ( 0, 49 ) ) {
        bBattleGlovesGlow_Switcher = FALSE;
        _asm {
            MOV DWORD PTR SS:[EBP-0x4], 0x2C
            JMP dwBattleGlovesGlow_Jump
...
Naked(cRFAddInventoryPos) {
    ...
    if ( IsRFItem == 0x04B3 ) {
        _asm {jmp RFPosition}
    }else if ( IsRFItem == ITEM2 ( 0, 41 ) ) { //Gloves1
        _asm {
			 FLD DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 42 ) ) { //Gloves2
        _asm {
			 FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 43 ) ) { //Gloves3
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 44 ) ) { //Gloves4
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 45 ) ) { //Gloves5
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 46 ) ) { //Gloves6
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 47 ) ) { //Gloves7
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 48 ) ) { //Gloves8
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 49 ) ) { //Gloves9
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
    ...
    }else if ( IsRFItem == ITEM2 ( 0, 50 ) ) { //Gloves10
        _asm {
			FLD DWORD PTR SS:[EBP-0x4c]
			FSUB QWORD PTR DS:[a1]/*0x0D27CA8]*/ //D28D58                     //FLOAT 0.004999999888241291
			FSTP DWORD PTR SS:[EBP-0x4c]
...
void InitBattleGloves() 
{
	...
	SetCompleteHook(0xE9,oBattleGloveGlow_Hook,&oBattleGloveGlow);
