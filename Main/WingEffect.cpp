...
Naked(AddWingsEffect)
{
	...
	if (IsCustomItem(AddWingsEffect_Buff, true))
	{
		if (AddWingsEffect_Buff == ITEM2(0, 102))
		{
			...
			pPlayDynamicEffect(32290, &F1_Arg11v2, F1_Arg2v2, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v3, F1_Arg2v3, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v4, F1_Arg2v4, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v5, F1_Arg2v5, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v6, F1_Arg2v6, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v7, F1_Arg2v7, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v8, F1_Arg2v8, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v9, F1_Arg2v9, Color, 12, 0.4f, 0);
			pPlayDynamicEffect(32290, &F1_Arg11v10, F1_Arg2v10, Color, 12, 0.4f, 0);		
		}
		...
		else if (AddWingsEffect_Buff == ITEM2(5, 102))
		{
			...
			pPlayDynamicEffect(0x7E0E, &F1_Arg11v2, F1_Arg2v2, Color, 0, 1.2f, 0);
		}
	...
	{
		if (AddWingsEffect_Buff == ITEM2(12, 200))
		{
			{
			...
			
			{
				...
				pPlayStaticEffect(0x7D83, &F1_Arg11v1, 0.6f, Color, F2_Arg5v1, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv2, &F1_Arg11v2, F1_Arg2v2, 24, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v2, 0.6f, Color, F2_Arg5v2, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv3, &F1_Arg11v3, F1_Arg2v3, 31, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v3, 0.6f, Color, F2_Arg5v3, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv4, &F1_Arg11v4, F1_Arg2v4, 40, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v4, 0.6f, Color, F2_Arg5v4, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv5, &F1_Arg11v5, F1_Arg2v5, 8, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v5, 0.6f, Color, F2_Arg5v5, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv6, &F1_Arg11v6, F1_Arg2v6, 17, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v6, 0.6f, Color, F2_Arg5v6, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv7, &F1_Arg11v7, F1_Arg2v7, 46, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v7, 0.6f, Color, F2_Arg5v7, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv8, &F1_Arg11v8, F1_Arg2v8, 23, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v8, 0.6f, Color, F2_Arg5v8, 1.0, 0);
				// --
				Color[0] = 1.0;
				Color[1] = 0.4f;
				Color[2] = 0.0;
				...
				pPlayStaticEffect(0x7D83, &F1_Arg11v9, 0.8f, Color, F2_Arg5v9, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv10, &F1_Arg11v10, F1_Arg2v10, 39, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v10, 0.8f, Color, F2_Arg5v10, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv11, &F1_Arg11v11, F1_Arg2v11, 44, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v11, 0.8f, Color, F2_Arg5v11, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv12, &F1_Arg11v12, F1_Arg2v12, 45, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v12, 0.8f, Color, F2_Arg5v12, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv13, &F1_Arg11v13, F1_Arg2v13, 12, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v13, 0.8f, Color, F2_Arg5v13, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv14, &F1_Arg11v14, F1_Arg2v14, 16, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v14, 0.8f, Color, F2_Arg5v14, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv15, &F1_Arg11v15, F1_Arg2v15, 21, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v15, 0.8f, Color, F2_Arg5v15, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv16, &F1_Arg11v16, F1_Arg2v16, 22, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v16, 0.8f, Color, F2_Arg5v16, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv17, &F1_Arg11v17, F1_Arg2v17, 61, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v17, 0.8f, Color, F2_Arg5v17, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv18, &F1_Arg11v18, F1_Arg2v18, 60, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v18, 0.8f, Color, F2_Arg5v18, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv19, &F1_Arg11v19, F1_Arg2v19, 59, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v19, 0.8f, Color, F2_Arg5v19, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv20, &F1_Arg11v20, F1_Arg2v20, 62, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v20, 0.8f, Color, F2_Arg5v20, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv21, &F1_Arg11v21, F1_Arg2v21, 55, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v21, 0.8f, Color, F2_Arg5v21, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv22, &F1_Arg11v22, F1_Arg2v22, 52, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v22, 0.8f, Color, F2_Arg5v22, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv23, &F1_Arg11v23, F1_Arg2v23, 53, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v23, 0.8f, Color, F2_Arg5v23, 1.0, 0);
				// --
				pAllowStaticEffect(F1_Thisv24, &F1_Arg11v24, F1_Arg2v24, 54, 0);
				pPlayStaticEffect(0x7D83, &F1_Arg11v24, 0.8f, Color, F2_Arg5v24, 1.0, 0);
				//----
				Color[0] = 1.0;
				Color[1] = 0.3f;
				Color[2] = 0.0;
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 201))
		{
			Color[0] = 0.34f;
			Color[1] = 0.25f;
			Color[2] = 1.0;
			...
			pPlayStaticEffect(32002, &F1_Arg11v8, 1.4f, Color, F2_Arg5v8, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv9, &F1_Arg11v9, F1_Arg2v9, 40, 0);
			pPlayStaticEffect(32002, &F1_Arg11v9, 1.4f, Color, F2_Arg5v9, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv10, &F1_Arg11v10, F1_Arg2v10, 62, 0);
			pPlayStaticEffect(32002, &F1_Arg11v10, 2.6f, Color, F2_Arg5v10, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv11, &F1_Arg11v11, F1_Arg2v11, 43, 0);
			pPlayStaticEffect(32002, &F1_Arg11v11, 2.6f, Color, F2_Arg5v11, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv12, &F1_Arg11v12, F1_Arg2v12, 65, 0);
			pPlayStaticEffect(32002, &F1_Arg11v12, 1.4f, Color, F2_Arg5v12, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv13, &F1_Arg11v13, F1_Arg2v13, 46, 0);
			pPlayStaticEffect(32002, &F1_Arg11v13, 1.4f, Color, F2_Arg5v13, 1.0, 0);
			// --
		...
		// --
		else if (AddWingsEffect_Buff == ITEM2(12, 206))
		{
			Color[0] = 0.0;
			Color[1] = 0.5;
			Color[2] = 0.7f;
			...
			//
			pPlayDynamicEffect(0x7e35, &F1_Arg11v1, F1_Arg2v1, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v2, F1_Arg2v2, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v3, F1_Arg2v3, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v4, F1_Arg2v4, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v5, F1_Arg2v5, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v6, F1_Arg2v6, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v7, F1_Arg2v7, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v8, F1_Arg2v8, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v9, F1_Arg2v9, Color, 0, 0.1f, 0.4f);

			pPlayDynamicEffect(0x7e35, &F1_Arg11v20, F1_Arg2v20, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v21, F1_Arg2v21, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v22, F1_Arg2v22, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v23, F1_Arg2v23, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v24, F1_Arg2v24, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v25, F1_Arg2v25, Color, 0, 0.1f, 0.4f);
			pPlayDynamicEffect(0x7e35, &F1_Arg11v26, F1_Arg2v26, Color, 0, 0.1f, 0.4f);
		}

		else if (AddWingsEffect_Buff == ITEM2(12, 208))
		{
			...
			pAllowStaticEffect(F1_Thisv17, &F1_Arg11v17, F1_Arg2v17, 17, 0);
			pPlayStaticEffect(32002, &F1_Arg11v17, 0.9f, Color, F2_Arg5v17, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv18, &F1_Arg11v18, F1_Arg2v18, 16, 0);
			pPlayStaticEffect(32002, &F1_Arg11v18, 0.9f, Color, F2_Arg5v18, 1.0, 0);
			...
			pPlayDynamicEffect(0x7e87, &F1_Arg11v3, F1_Arg2v3, Color, 0.5, 0.3f, 1);
			pPlayDynamicEffect(0x7e87, &F1_Arg11v1, F1_Arg2v1, Color, 0.5, 0.3f, 1);

			pPlayDynamicEffect(0x7e85, &F1_Arg11v15, F1_Arg2v15, Color, 0.5, 0.3f, 1);
			pPlayDynamicEffect(0x7e86, &F1_Arg11v14, F1_Arg2v14, Color, 0.5, 0.5, 1);
			pPlayDynamicEffect(0x7e87, &F1_Arg11v19, F1_Arg2v19, Color, 0.5, 0.3f, 1);
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 209))
		{
			// --
			Color[0] = 1.5;
			Color[1] = 1.5;
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 218))
		{
			// --
			Color[0] = 1.5;
			Color[1] = 1.5;
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 210))
		{
			Color[0] = 1.5;
			Color[1] = 0.0;
			Color[2] = 0.0;
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 204))
		{
			Color[0] = 1.5;
			Color[1] = 1.0;
			Color[2] = 0.0;
			// --
			pAllowStaticEffect(F1_Thisv16, &F1_Arg11v16, F1_Arg2v16, 16, 0);
			pPlayStaticEffect(32002, &F1_Arg11v16, 0.8f, Color, F2_Arg5v16, 2.0, 0);
			//
			pAllowStaticEffect(F1_Thisv8, &F1_Arg11v8, F1_Arg2v8, 8, 0);
			pPlayStaticEffect(32002, &F1_Arg11v8, 0.8f, Color, F2_Arg5v8, 0, 0);
			// --
			Color[0] = 1.0;
			Color[1] = 0.0;
			Color[2] = 0.0;
		...
		//
		else if (AddWingsEffect_Buff == ITEM2(12, 217))
		{
			Color[0] = 1.0;
			Color[1] = 0.5;
			Color[2] = 0.5;
			// --
			pAllowStaticEffect(F1_Thisv1, &F1_Arg11v1, F1_Arg2v1, 11, 0);
			pPlayStaticEffect(32002, &F1_Arg11v1, 1.3f, Color, F2_Arg5v1, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv2, &F1_Arg11v2, F1_Arg2v2, 12, 0);
			pPlayStaticEffect(32002, &F1_Arg11v2, 1.3f, Color, F2_Arg5v2, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv3, &F1_Arg11v3, F1_Arg2v3, 13, 0);
			pPlayStaticEffect(32002, &F1_Arg11v3, 1.3f, Color, F2_Arg5v3, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv4, &F1_Arg11v4, F1_Arg2v4, 14, 0);
			pPlayStaticEffect(32002, &F1_Arg11v4, 1.3f, Color, F2_Arg5v4, 1.0, 0);
			// --


			pPlayDynamicEffect(0x7d69, &F1_Arg11v1, F1_Arg2v1, Color, 0, 0.3f, 0);
			pPlayDynamicEffect(0x7e73, &F1_Arg11v2, F1_Arg2v2, Color, 0, 1, 1);
			pPlayDynamicEffect(0x7e73, &F1_Arg11v3, F1_Arg2v3, Color, 0, 1, 1);
			pPlayDynamicEffect(0x7e73, &F1_Arg11v4, F1_Arg2v4, Color, 0, 1, 1);
			// --
			...
			Color[2] = 1.5;
			pAllowStaticEffect(F1_Thisv6, &F1_Arg11v6, F1_Arg2v6, 6, 0);
			pPlayStaticEffect(32002, &F1_Arg11v6, 1.3f, Color, F2_Arg5v6, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv7, &F1_Arg11v7, F1_Arg2v7, 7, 0);
			pPlayStaticEffect(32002, &F1_Arg11v7, 1.3f, Color, F2_Arg5v7, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv8, &F1_Arg11v8, F1_Arg2v8, 8, 0);
			pPlayStaticEffect(32002, &F1_Arg11v8, 1.3f, Color, F2_Arg5v8, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv5, &F1_Arg11v5, F1_Arg2v5, 5, 0);
			pPlayStaticEffect(32002, &F1_Arg11v5, 1.3f, Color, F2_Arg5v5, 1.0, 0);
			// --
			pAllowStaticEffect(F1_Thisv10, &F1_Arg11v10, F1_Arg2v10, 10, 0);
			pPlayStaticEffect(32002, &F1_Arg11v10, 1.3f, Color, F2_Arg5v10, 1.0, 0);
			// --
			pPlayDynamicEffect(0x7e73, &F1_Arg11v6, F1_Arg2v6, Color, 0, 1, 1);
			pPlayDynamicEffect(0x7e73, &F1_Arg11v7, F1_Arg2v7, Color, 0, 1, 1);
			pPlayDynamicEffect(0x7e73, &F1_Arg11v8, F1_Arg2v8, Color, 0, 1, 1);
			...
			pPlayStaticEffect(32002, &F1_Arg11v14, 1.3f, Color, F2_Arg5v14, 2.0, 0);
			pAllowStaticEffect(F1_Thisv15, &F1_Arg11v15, F1_Arg2v15, 20, 0);
			pPlayStaticEffect(32002, &F1_Arg11v15, 1.3f, Color, F2_Arg5v15, 2.0, 0);
			pAllowStaticEffect(F1_Thisv16, &F1_Arg11v16, F1_Arg2v16, 21, 0);
			pPlayStaticEffect(32002, &F1_Arg11v16, 1.3f, Color, F2_Arg5v16, 2.0, 0);
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 222))
		{
			Color[0] = 2.0;
			Color[1] = 0.5;
			Color[2] = 0.5;
			...
			pPlayDynamicEffect(0x7d65, &F1_Arg11v7, F1_Arg2v7, Color, 11, 0.1f, 12);
		}
		// --
		else if (AddWingsEffect_Buff == ITEM2(12, 223))
		{
			Color[0] = 1.0;
			Color[1] = 0.0;
			Color[2] = 0.5;
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 225))
		{
			Color[0] = 0.0;
			Color[1] = 0.0;
			Color[2] = 0.0;
		...
		else if (AddWingsEffect_Buff == ITEM2(12, 216))
		{
			Color[0] = 0.0;
			Color[1] = 0.0;
			Color[2] = 2.0;
			...
			// --
			pPlayDynamicEffect(0x7E1C, &F1_Arg11v1, F1_Arg2v1, Color, 0, 0.8f, 1);
			pPlayDynamicEffect(0x7E1C, &F1_Arg11v2, F1_Arg2v2, Color, 0, 0.8f, 1);
			pPlayDynamicEffect(0x7E1C, &F1_Arg11v3, F1_Arg2v3, Color, 0, 0.8f, 1);
			// --
			...
			// --
			pPlayDynamicEffect(0x7E1C, &F1_Arg11v4, F1_Arg2v4, Color, 0, 0.8f, 1);
			pPlayDynamicEffect(0x7E1C, &F1_Arg11v5, F1_Arg2v5, Color, 0, 0.8f, 1);
			pPlayDynamicEffect(0x7E1C, &F1_Arg11v6, F1_Arg2v6, Color, 0, 0.8f, 1);
			// --
		}
		else if (AddWingsEffect_Buff == ITEM2(12, 207))
		{
			Color[0] = 1.0;
			Color[1] = 0.5;
			Color[2] = 0.0;
